...
from device.peripherals.modules.actuator_relays import driver
from device.peripherals.modules.actuator_relays import exceptions, events


class ActuatorRelaysManager(manager.PeripheralManager):
    """Manages an actuator controlled by a ArduinoRelays io expander."""

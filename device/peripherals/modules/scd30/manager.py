...
from device.peripherals.modules.scd30 import driver, exceptions


class SCD30Manager(manager.PeripheralManager):
    """Manages an scd30 temperature, humidity and co2 sensor."""
    ...
    def initialize_peripheral(self) -> None:
        ...
        # Initialize driver
        try:
            self.driver = driver.SCD30Driver(
                name=self.name,
